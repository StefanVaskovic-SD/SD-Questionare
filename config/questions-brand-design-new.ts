...
// Brand Design (New) Questionnaire Configuration
export const BRAND_DESIGN_NEW_CONFIG: QuestionnaireConfig = {
    ...
    // ========================================
    {
      ...
      questions: [
        ...
        },
        {
          ...
          required: false,
          groupTitle: 'Brand promise & distinctiveness',
          helper: 'This field is shown only for rebrand projects.',
        },
      ],
    },
