...
// Product Design (New) Questionnaire Configuration
export const PRODUCT_DESIGN_NEW_CONFIG: QuestionnaireConfig = {
  ...
  sections: [
    ...
    // ========================================
    {
      ...
      questions: [
        {
          key: 'core_product',
          label: 'The core product - the main digital product (app, website, platform, internal tool, etc.)',
          type: 'textarea',
          required: false,
        ...
        {
          key: 'integrations',
          label: 'Integrations - Describe how the product connects with other services or platforms.',
          type: 'textarea',
          required: false,
          groupTitle: 'Describe the current product ecosystem',
        },
        {
          ...
          label: 'Supporting systems and tools - List and describe external or internal systems your product depends on, such as: Databases, Content management systems, Authentication systems, Analytics tools, Payment gateways, CRM/ERP systems, Third-party APIs',
          type: 'textarea',
          required: false,
          groupTitle: 'Describe the current product ecosystem',
        },
        {
          ...
          label: 'Dependencies and constraints - anything in the ecosystem that limits or shapes development: Legacy systems, Compliance requirements, Technical constraints, Vendor contracts',
          type: 'textarea',
          required: false,
          groupTitle: 'Describe the current product ecosystem',
        },
