      ...
      questions: [
        {
          ...
          type: 'textarea',
          required: false,
          helper: 'Understanding existing tools helps identify the technological foundation and capabilities that could be integrated into a future website.',
        },
        {
          ...
          type: 'textarea',
          required: false,
          helper: 'This question explores current data practices and desired insights to inform future marketing strategies and website functionality.',
        },
        {
          ...
          type: 'textarea',
          required: false,
          helper: 'Knowing the current CRM allows for better planning of lead management and customer engagement processes online.',
        },
        {
          ...
          type: 'textarea',
          required: false,
          helper: 'Understanding current email marketing practices reveals opportunities for lead nurturing and customer communication through a website.',
        },
        {
          key: 'seo_approach',
          ...
          type: 'textarea',
          required: false,
          helper: 'Identifying SEO goals and familiarity with tools helps assess the strategy for driving organic traffic once the website launches.',
        },
        {
          ...
          type: 'textarea',
          required: false,
          helper: 'Understanding CMS preferences and content goals provides insights into future content creation and website maintainability.',
        },
        {
          ...
          type: 'textarea',
          required: false,
          helper: 'Exploring current social media presence reveals opportunities for leveraging social channels through the website for user interaction and brand awareness.',
        },
        {
          ...
          type: 'textarea',
          required: false,
          helper: 'Understanding existing automation practices helps identify opportunities for efficiency in lead nurturing and customer communication.',
        },
        {
          ...
          type: 'textarea',
          required: false,
          helper: 'Knowing the mindset toward experimentation provides insights into future optimization efforts and data-driven decision-making.',
        },
        {
          key: 'martech_goals',
          ...
          type: 'textarea',
          required: false,
          helper: 'Understanding objectives for martech investments helps align technology choices with business strategy and user needs.',
        },
        {
          ...
          type: 'textarea',
          required: false,
          helper: 'Knowing current compliance practices ensures that future website implementation will handle user data responsibly and legally.',
        },
      ],
    },
  ],
